...
;; Create a reckoner — the learning primitive.
;; Labels are registered after construction via (register reckoner name).
...
;; Ask what the reckoner thinks about a thought.
...
;; How many times the reckoner has rebuilt its prototypes.
...
;; None if < 2 labels registered or reckoner not yet calibrated.
;; The discriminant IS the reckoner's learned knowledge, externalized.
...
(curve reckoner) → (amplitude, exponent)
